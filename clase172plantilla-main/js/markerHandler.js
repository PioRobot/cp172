...
//menos 2 de zoom`–
      //Crear las columnas de la tabla para NOMBRE DEL ARTÍCULO, PRECIO, CANTIDAD y PRECIO TOTAL`    var item = document.createElement("td");
      ...
      c1.setAttribute("class","no-line")

      var c2=document.createElement("td")
      c2.setAttribute("class","no-line")

      var c3=document.createElement("td")
      c4.setAttribute("class","no-line text-center")
      var textTotal=document.createElement("strong")
      textTotal.innerHTML="Total"
      c3.appendChild(textTotal)

      var c4=document.createElement("td")
      c1.setAttribute("class","no-line text-right")
      //var price=document.createElement("strong")
      c4.innerHTML="$"+orderSummary.total_bill
  ...
  handlePayment:function(){
    ...
    .then(()=>{
      swal({
        ...
        text: "hope you enjoyed the food",
        timer: 2500,
        buttons: false
      })
    })
